...
class CPUTest(unittest.TestCase):
    ...
    def test_com_positive(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101001000010"))
        self.ps.clear()
    ...
    def test_inc_not_overflow(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101010000010"))
    ...
    def test_dec_not_overflow(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101011000010"))
    ...
    def test_neg_positive(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101100000010"))
        self.registers[2].set_word(value=bitarray("0111111111111111"))
        self.ps.clear()
        self.ps.set(bit="Z", value=True)
        self.ps.set(bit="V", value=True)
    ...
    def test_test_negative(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101111000010"))
        self.registers[2].set_word(value=bitarray("1000000000000000"))
        self.ps.clear()
        self.ps.set(bit="C", value=True)
        self.ps.set(bit="V", value=True)
    ...
    def test_asr_negative(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000110010000010"))
    ...
    def test_asl_negative(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000110011000010"))
        self.registers[2].set_word(value=bitarray("1011000000000001"))
        self.ps.clear()
        self.ps.set(bit="N", value=True)
        self.ps.set(bit="Z", value=True)
    ...
    def test_ror(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000110000000010"))
    ...
    def test_rol(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000110001000010"))
    ...
    def test_swab(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000000011000010"))
    ...
    def test_adc_unsigned_overflow(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101101000010"))
        self.registers[2].set_word(value=bitarray("1111111111111111"))
        self.ps.clear()
        self.ps.set(bit="C", value=True)
        self.ps.set(bit="V", value=True)
    ...
    def test_sbc_unsigned_overflow(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000101110000010"))
        self.registers[2].set_word(value=bitarray("0000000000000000"))
        self.ps.clear()
        self.ps.set(bit="V", value=True)
        self.ps.set(bit="Z", value=True)
    ...
    def test_sxt_set(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000110111000010"))
    ...
    def test_mov_byte_reg(self):
        self.memory.store(address=256, size="word", mem=bitarray("1001010111000010"))
        self.memory.store(address=258, size="word", mem=bitarray("0000000011000000"))
    ...
    def test_mov_byte_not_reg(self):
        self.memory.store(address=256, size="word", mem=bitarray("1001010111001010"))
        self.memory.store(address=258, size="word", mem=bitarray("0000001111000000"))
    ...
    def test_cmp_v_set_c_clear(self):
        self.memory.store(address=256, size="word", mem=bitarray("0010000011000010"))
    ...
    def test_add_v_set_c_set(self):
        self.memory.store(address=256, size="word", mem=bitarray("0110000011000010"))
    ...
    def test_sub_v_set_c_set(self):
        self.memory.store(address=256, size="word", mem=bitarray("1110000011000010"))
    ...
    def test_bit(self):
        self.memory.store(address=256, size="word", mem=bitarray("0011000011000010"))
        self.registers[2].set_word(value=bitarray("1000100010100101"))
    ...
    def test_bic(self):
        self.memory.store(address=256, size="word", mem=bitarray("0100000011000010"))
        self.registers[2].set_word(value=bitarray("1000100010100101"))
    ...
    def test_bis(self):
        self.memory.store(address=256, size="word", mem=bitarray("0101000011000010"))
        self.registers[2].set_word(value=bitarray("1000100010100101"))
        self.registers[3].set_word(value=bitarray("0111011111011010"))
        self.ps.clear()
        self.ps.set(bit="Z", value=True)
    ...
    def test_mark(self):
        self.memory.store(address=256, size="word", mem=bitarray("0000110100000010"))
        self.memory.store(address=65532, size="word", mem=bitarray("0101001111111111"))
        self.registers[5].set_word(value=bitarray("1000100010100100"))
    ...
    def test_sob_zero(self):
        self.memory.store(address=256, size="word", mem=bitarray("0111111010000010"))
        self.registers[2].set_word(value=bitarray("0000000000000001"))
        self.cpu.execute_next()
